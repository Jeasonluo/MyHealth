...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout = findViewById(R.id.main_activity_coordinatorLayout);

        RecyclerView recyclerView = findViewById(R.id.recycleView_checklists);
        ...
        FloatingActionButton floating_add = findViewById(R.id.floating_checkItem_add);
        floating_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AddEditChecklistActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == ADD_CHECKITEM_REQUEST && resultCode == RESULT_OK){
            ...
            if(id == -1){
                Toast.makeText(this, "Item Not Able to Update", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            Toast.makeText(this, "CheckItem Updated", Toast.LENGTH_SHORT).show();
            return;
    ...
    private void showSnackBar(final Checklist item) {
        //Toast.makeText(this, "Snack Bar Clicked", Toast.LENGTH_SHORT).show();
